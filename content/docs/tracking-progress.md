...
Column view is a good way to view properties of headers. While we can view to-do status, categories, tags, time logged, and other standard properties, we can add our own, custom properties, and this is where it gets real interesting for creative writers.
