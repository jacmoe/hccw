...
The `Vale` syntax checker will not check inside headings tagged with _noexport_. Outside the _noexport_ sections we can use these comments to turn Vale off and on:
